...
export default function ReturnUnsynchronized() {
    ...
    return (
        <div className="absolute inset-0 flex justify-center items-center border border-gray-500 dark:border-gray-600 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 w-[70%] h-[30%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
