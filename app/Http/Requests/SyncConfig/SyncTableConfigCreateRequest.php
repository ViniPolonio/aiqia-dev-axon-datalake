...
class SyncTableConfigCreateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'oracle_name'       => 'bail|required|string|max:255',
            'mysql_name'        => 'bail|required|string|max:255',
            'field_check_name'  => 'bail|required|string|max:255',
            'uniq_fields_name'  => 'bail|required|string|max:255',
            'active'            => 'bail|integer',
        ];
    }
