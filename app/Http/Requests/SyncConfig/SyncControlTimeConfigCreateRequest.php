...
class SyncControlTimeConfigCreateRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'sync_control_config_id.required' => 'The sync table config ID field is required.',
            'sync_control_config_id.exists'   => 'The sync table config id is not exists',
